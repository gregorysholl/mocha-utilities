...
class MochaErrorTest: XCTestCase {
    ...
    func testShouldntBeNil() {
        ...
        let appSecurityTransport = MochaError.appSecurityTransport
        ...
        XCTAssertNotNil(appSecurityTransport)
    ...
    func testEquality() {
        ...
        XCTAssertNotEqual(MochaError.appSecurityTransport, .fileNotFound)
        XCTAssertNotEqual(MochaError.fileNotFound, .notImplemented)
        XCTAssertNotEqual(MochaError.notImplemented, .serialization)
        XCTAssertNotEqual(MochaError.serialization, .appSecurityTransport)
    }
}
